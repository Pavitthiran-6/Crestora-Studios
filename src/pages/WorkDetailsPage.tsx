    ...
    <section ref={container} className="relative h-full shrink-0 overflow-hidden bg-[#f5f5f3]">
      <div className="relative h-full w-full flex flex-col items-center justify-center -top-10 md:-top-16">
        <motion.div 
          ...
          className="absolute z-0 w-[90vw] h-[90vw] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 md:inset-0 md:w-full md:h-full md:translate-x-0 md:translate-y-0 pointer-events-none md:pointer-events-auto"
        >
