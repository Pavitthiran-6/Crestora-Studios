...
const PROCESS_STEPS = [
  {
    id: "01",
    title: "STORYBOARD",
    desc: "Translating concepts into sequential vector frames to establish motion paths, speed timing, and transitions."
  },
  {
    id: "02",
    title: "STYLE FRAMES",
    desc: "Designing select vector illustrations as standalone high-res artwork, establishing color contrasts and details."
  },
  {
    id: "03",
    title: "ANIMATION",
    desc: "Applying fluid keyframes and kinetic motion physics, driving clean asset dynamics that elevate engagement."
  },
  {
    id: "04",
    title: "SOUND DESIGN",
    desc: "Syncing sound effects, voice tracks, and custom background music to lock visual transitions with audio cues."
  },
  {
    id: "05",
    title: "DELIVERY",
    desc: "Compiling finished sequences into optimized, lightweight digital formats for fast web and application playback."
  }
];
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#567C8D" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#567C8D] leading-none">MOTION GRAPHICS</span>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            ...
            >
              <p className="text-xl md:text-2xl font-display font-black tracking-[-0.02em] leading-tight uppercase text-white">
                WE CREATE IMMERSIVE MOTION GRAPHICS AND DYNAMIC INTERACTIVE ANIMATIONS THAT ELEVATE DIGITAL BRAND STORYTELLING.
              </p>
            </motion.div>
            ...
            >
              <p className="text-base md:text-lg font-display font-black tracking-[-0.01em] leading-relaxed opacity-40 uppercase">
                At Crestora, our motion graphics solutions bring digital assets to life. We structure visual storyboards, custom vector physics, and precise keyframing systems, turning basic vectors and text arrays into engaging animations that lock customer attention.
              </p>
            </motion.div>
          </div>
        </div>
