...
const PROCESS_STEPS = [
  {
    ...
    desc: "Deploying active monitoring to check server response delays, frontend telemetry scripts, and database sync status."
  },
  {
    id: "02",
    title: "PATCH ENGINE",
    desc: "Scheduling systematic package upgrades, styling patches, and security hotfixes to prevent performance rot."
  },
  {
    id: "03",
    title: "BACKUP PIPELINES",
    desc: "Configuring automated, secure database backup intervals to ensure zero state loss during incident rollbacks."
  },
  {
    id: "04",
    title: "CALIBRATION",
    desc: "Optimizing database index layers, query response limits, and file assets to preserve premium page rendering speeds."
  },
  {
    id: "05",
    title: "HELPDESK RESPONSE",
    desc: "Addressing custom client requests, feature enhancements, and system bugs under strict Service Level Agreements."
  }
];
...
export default function WebsiteAppMaintenancePage() {
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#567C8D" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#567C8D] leading-none">WEBSITE AND APP MAINTENANCE</span>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            ...
            >
              <p className="text-xl md:text-2xl font-display font-black tracking-[-0.02em] leading-tight uppercase text-white">
                WE ENGINEER PROACTIVE MAINTENANCE FLOWS TO GUARANTEE NOMINAL TELEMETRY VALUES AND CONTINUOUS SITE VELOCITY.
              </p>
            </motion.div>
            ...
            >
              <p className="text-base md:text-lg font-display font-black tracking-[-0.01em] leading-relaxed opacity-40 uppercase">
                At Crestora, our website and app support services protect your system infrastructure. We automate security patches, schedule database backups, review query response metrics, and maintain a dedicated support line to address runtime issues.
              </p>
            </motion.div>
          </div>
        </div>
