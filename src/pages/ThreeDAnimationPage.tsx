...
const PROCESS_STEPS = [
  {
    id: "01",
    title: "3D MODELING",
    desc: "Sculpting precise dimensional models, grids, and environments to establish product shapes or figures."
  },
  {
    id: "02",
    title: "TEXTURING & LIGHT",
    desc: "Applying realistic materials, reflections, physical textures, and ambient lighting set pieces."
  },
  {
    id: "03",
    title: "KINETIC ANIMATION",
    desc: "Prototyping dynamic camera paths, product movements, and physics-based animations to create visual immersion."
  },
  {
    id: "04",
    title: "RENDER PASSES",
    desc: "Calculating high-definition output frames with rich shadows, refractions, and details."
  },
  {
    id: "05",
    title: "COMPOSITING & LAUNCH",
    desc: "Merging visual components with ad layers and exporting commercial video assets optimized for screens."
  }
];
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#567C8D" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#567C8D] leading-none">3D ANIMATION</span>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            ...
            >
              <p className="text-xl md:text-2xl font-display font-black tracking-[-0.02em] leading-tight uppercase text-white">
                WE ENGINEER SOPHISTICATED 3D ANIMATIONS AND CINEMATIC ADVERTISING CONCEPTS FOR PREMIUM BRAND EXPERIENCES.
              </p>
            </motion.div>
            ...
            >
              <p className="text-base md:text-lg font-display font-black tracking-[-0.01em] leading-relaxed opacity-40 uppercase">
                At Crestora, our 3D animation and advertising services bring product geometries and brand concepts to life. We focus on photorealistic texturing, dynamic lighting paths, and physics-based motion transitions to ensure your campaigns deliver maximum visual impact.
              </p>
            </motion.div>
          </div>
        </div>
