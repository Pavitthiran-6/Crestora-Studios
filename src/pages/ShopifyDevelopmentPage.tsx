              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#ef4444" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#ef4444] leading-none">SHOPIFY DEVELOPMENT</span>
                  </div>
                </div>
    ...
    <section className="h-full relative flex flex-col pt-16 md:pt-20 pb-8 overflow-hidden justify-center">
      <Layout>
        ...
        <div className="flex flex-col mb-6 md:mb-10">
          <CinematicText as="h1" className="text-[12vw] md:text-[10vw] font-display font-black tracking-[-0.04em] uppercase leading-[0.85] text-[#ef4444]" intensity={1.2}>SHOPIFY</CinematicText>
