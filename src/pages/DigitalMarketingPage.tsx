...
const PROCESS_STEPS = [
  {
    ...
    desc: "Segmenting customer profiles, researching keyword intents, and mapping target demographics to prevent ad-spend waste."
  },
  {
    id: "02",
    title: "CAMPAIGN OUTLINE",
    desc: "Drafting cross-channel campaign maps across social media feeds, search listings, and email automation drip systems."
  },
  {
    id: "03",
    title: "AD DESIGN & COPY",
    desc: "Designing high-conversion graphics, recording creative videos, and writing persuasive ad copy."
  },
  {
    id: "04",
    title: "FUNNEL AUDIT",
    desc: "Auditing landing page performance, tracking pixels, and cart layouts to maximize conversions and user retention."
  },
  {
    id: "05",
    title: "BID SCALING",
    desc: "Monitoring search traffic, balancing active bidding limits, and scaling budgets based on performance KPIs."
  }
];
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#567C8D" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#567C8D] leading-none">DIGITAL MARKETING</span>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            ...
            >
              <p className="text-xl md:text-2xl font-display font-black tracking-[-0.02em] leading-tight uppercase text-white">
                WE ENGINEER HIGH-CONVERTING DIGITAL CAMPAIGNS MERGING CREATIVE DESIGN WITH DATA-DRIVEN SCALING STRATEGY.
              </p>
            </motion.div>
            ...
            >
              <p className="text-base md:text-lg font-display font-black tracking-[-0.01em] leading-relaxed opacity-40 uppercase">
                At Crestora, our digital marketing services combine custom ad creative, persuasive copy structures, and data audits. We configure automated campaign tracks across social platforms, search listings, and newsletters, optimizing budgets to drive brand presence and compound ROI.
              </p>
            </motion.div>
          </div>
        </div>
