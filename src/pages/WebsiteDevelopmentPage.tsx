...
const PROCESS_STEPS = [
  {
    id: "01",
    title: "PLANNING",
    desc: "We begin by detailing system requirements, mapping out information flow, and selecting the optimal technology stack for maximum performance, security, and scalability."
  },
  {
    id: "02",
    title: "PROTOTYPING",
    desc: "Developing interactive high-fidelity structural templates that prioritize clean page hierarchy, flawless UX, and conversion funnels before writing core code."
  },
  {
    id: "03",
    title: "DEVELOPMENT",
    desc: "Engineering premium, reusable component libraries using state-of-the-art libraries, ensuring smooth animations, fast loading speeds, and accessibility compliance."
  },
  {
    id: "04",
    title: "INTEGRATION",
    desc: "Integrating CMS editors, payment setups, third-party APIs, and real-time database syncing (such as Supabase) to deliver dynamic operational features."
  },
  {
    id: "05",
    title: "OPTIMIZATION & LAUNCH",
    desc: "Performing rigorous audits for speed, browser compatibility, and basic SEO settings before launching your platform to the global market."
  }
];
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#567C8D" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#567C8D] leading-none">WEBSITE DEVELOPMENT</span>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            ...
            >
              <p className="text-xl md:text-2xl font-display font-black tracking-[-0.02em] leading-tight uppercase text-white">
                WE ENGINEER HIGH-PERFORMANCE WEBSITES WITH MODERN ARCHITECTURE, FLUID MOTION, AND SCALABLE FUNCTIONALITIES.
              </p>
            </motion.div>
            ...
            >
              <p className="text-base md:text-lg font-display font-black tracking-[-0.01em] leading-relaxed opacity-40 uppercase">
                At Crestora, our website development services turn ambitious designs into responsive, production-ready platforms. We build using cutting-edge technologies, prioritizing clean code architecture, absolute page performance, accessibility benchmarks, and intuitive administration controls to fuel the scale of your business.
              </p>
            </motion.div>
          </div>
        </div>
