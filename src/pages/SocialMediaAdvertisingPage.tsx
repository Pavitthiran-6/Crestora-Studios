...
const PROCESS_STEPS = [
  { id: "01", title: "AUDIENCE TARGETING", desc: "Precision at scale. We leverage deep demographic and behavioral data to build highly-refined audience segments, ensuring your brand message is delivered to the exact people most likely to engage and convert." },
  { id: "02", title: "CREATIVE DESIGN", desc: "Stopping the scroll through cinematic visual storytelling. We craft bespoke ad assets that merge high-end aesthetics with persuasive psychological triggers, ensuring your brand stands out in a crowded social landscape." },
  { id: "03", title: "CAMPAIGN LAUNCH", desc: "Surgical orchestration across multiple social platforms. We manage the technical deployment of your campaigns, optimizing placements and bidding strategies for maximum reach and immediate impact." },
  { id: "04", title: "A/B TESTING", desc: "Continuous strategic refinement. We conduct rigorous split testing of creative assets, copy variations, and audience segments to identify the high-performance combinations that deliver the best possible ROI." },
  { id: "05", title: "PERFORMANCE ANALYSIS", desc: "Turning data into actionable growth. We provide sophisticated, real-time reporting that tracks campaign efficiency and conversion metrics, allowing us to pivot and scale based on surgical performance insights." }
];

const OTHER_SERVICES = [
  "Website design", "Motion design", "Front-end development", "Back-end development",
  "Shopify development", "Website support", "Paid search advertising", "Email marketing", "SEO"
];
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#567C8D" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#567C8D] leading-none">SOCIAL MEDIA ADVERTISING</span>
                  </div>
                </div>
    ...
    <section className="h-full relative flex flex-col pt-16 md:pt-20 pb-8 overflow-hidden justify-center">
      <Layout>
        ...
        <div className="flex flex-col mb-6 md:mb-10">
          <CinematicText as="h1" className="text-[12vw] md:text-[10vw] font-display font-black tracking-[-0.04em] uppercase leading-[0.85] text-[#567C8D]" intensity={1.2}>SOCIAL MEDIA</CinematicText>
          <CinematicText as="h1" className="text-[12vw] md:text-[10vw] font-display font-black tracking-[-0.04em] uppercase leading-[0.85] text-white" intensity={1.2}>ADVERTISING</CinematicText>
        </div>
