...
const PROCESS_STEPS = [
  ...
  { id: "02", title: "AD CREATIVE", desc: "Stopping the scroll through high-impact visual and textual storytelling. We craft compelling ad copy and cinematic visual assets that resonate with your target audience and command a premium click-through rate." },
...
const OTHER_SERVICES = [
  ...
  "Shopify development", "Website support", "Social media advertising", "Email marketing", "SEO"
];

export default function PaidSearchAdvertisingPage() {
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#567C8D" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#567C8D] leading-none">PAID SEARCH ADVERTISING</span>
                  </div>
                </div>
    ...
    <section className="h-full relative flex flex-col pt-16 md:pt-20 pb-8 overflow-hidden justify-center">
      <Layout>
        ...
        <div className="flex flex-col mb-6 md:mb-10">
          <CinematicText as="h1" className="text-[12vw] md:text-[10vw] font-display font-black tracking-[-0.04em] uppercase leading-[0.85] text-[#567C8D]" intensity={1.2}>PAID SEARCH</CinematicText>
        ...
        <div className="w-full space-y-4 md:space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.5 }} className="md:col-span-4"><p className="text-xl md:text-2xl font-display font-black tracking-[-0.02em] leading-tight uppercase text-white">WE DRIVE IMMEDIATE, HIGH-INTENT TRAFFIC THROUGH SURGICAL SEARCH ENGINE MARKETING STRATEGIES AND CONVERSION-FOCUSED CREATIVE.</p></motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="md:col-span-6"><p className="text-base md:text-lg font-display font-black tracking-[-0.01em] leading-relaxed opacity-40 uppercase">Paid search at Crestora Studios is a marriage of data science and persuasive art. We go beyond simple keyword bidding, crafting complete digital journeys that capture attention and compel action. By leveraging advanced attribution modeling and bespoke landing page architecture, we ensure your ad spend is not just a cost, but a high-performance investment that delivers measurable growth and brand authority.</p></motion.div>
          </div>
        </div>
      </Layout>
    </section>
