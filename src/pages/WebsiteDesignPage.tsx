              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#ef4444" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#ef4444] leading-none">WEBSITE DESIGN</span>
                  </div>
                </div>
...
function ProcessCard({ step, index }: { step: any; index: number }) {
  ...
  return (
    <div
      className={cn(
        "flex-shrink-0 w-[85vw] md:w-[450px] min-h-[400px] md:h-[550px] group relative bg-[#1f2547] p-10 md:p-16 rounded-[32px] border border-white/10 hover:border-white/20 transition-all duration-500 hover:shadow-[0_40px_80px_rgba(0,0,0,0.5)] flex flex-col",
        shiftClass
      )}
    >
      <div className="flex flex-col h-full">
        ...
        <h3 className="text-4xl md:text-6xl font-display font-black tracking-[-0.04em] uppercase leading-none mb-8 group-hover:text-[#ef4444] transition-colors text-white">
          {step.title}
        </h3>
