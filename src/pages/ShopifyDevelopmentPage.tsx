...
const PROCESS_STEPS = [
  { id: "01", title: "STORE SETUP", desc: "We lay the foundation for your e-commerce empire. Our setup phase includes precise configuration of your Shopify environment, ensuring every setting is optimized for high-volume sales and global reach." },
  { id: "02", title: "THEME CUSTOMIZATION", desc: "Transforming standard templates into bespoke brand statements. We tailor every aspect of your Shopify theme, from liquid logic to visual aesthetics, ensuring your store is as unique as your brand." },
  { id: "03", title: "APP INTEGRATION", desc: "Expanding your store's capabilities through surgical integration of premium Shopify apps. We choose and configure the right tools to streamline your operations and enhance the customer experience." },
  { id: "04", title: "E-COMMERCE STRATEGY", desc: "Driving growth through data-driven insights. We define your product architecture, pricing strategy, and customer journey to ensure your store is a high-performance sales engine." },
  { id: "05", title: "CONVERSION OPTIMIZATION", desc: "Squeezing every drop of value from your traffic. We conduct rigorous A/B testing and user behavior analysis to continuously refine your checkout flow and product pages for maximum ROI." }
];

const OTHER_SERVICES = [
  "Website design", "Motion design", "Front-end development", "Back-end development",
  "Website support", "Paid search advertising", "Social media advertising", "Email marketing", "SEO"
];
              ...
              <div className="px-6 md:px-12 lg:px-16 py-8 md:py-12 flex justify-between items-start">
                <div className="flex items-center gap-8 pointer-events-auto">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    ...
                    <HexIcon className="w-2.5 h-2.5" fill="#567C8D" />
                    <span className="text-[10px] font-black tracking-[0.3em] uppercase text-[#567C8D] leading-none">SHOPIFY DEVELOPMENT</span>
                  </div>
                </div>
    ...
    <section className="h-full relative flex flex-col pt-16 md:pt-20 pb-8 overflow-hidden justify-center">
      <Layout>
        ...
        <div className="flex flex-col mb-6 md:mb-10">
          <CinematicText as="h1" className="text-[12vw] md:text-[10vw] font-display font-black tracking-[-0.04em] uppercase leading-[0.85] text-[#567C8D]" intensity={1.2}>SHOPIFY</CinematicText>
          <CinematicText as="h1" className="text-[12vw] md:text-[10vw] font-display font-black tracking-[-0.04em] uppercase leading-[0.85] text-white" intensity={1.2}>DEVELOPMENT</CinematicText>
        </div>
